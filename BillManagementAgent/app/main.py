...
# --- SIDEBAR ---
st.sidebar.image("https://img.icons8.com/color/96/receipt-approved.png", width=80)
st.sidebar.markdown("""
# 🧾 Bill Management Agent

**AI-powered bill analysis and expense insights.**
...
st.markdown("""
    ...
    <hr style='border: 1px solid #667eea; margin-bottom: 2rem;'>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div class="upload-section">
        ...
        <p style='text-align:center; color:#fff; opacity:0.8;'>Supported formats: JPG, JPEG, PNG</p>
        <div class="upload-area">
            <span style="font-size:2.5rem;">⬆️</span>
            <p>Drag & drop or browse to select your bill image</p>
        </div>
    </div>
""", unsafe_allow_html=True)
...
if uploaded_file:
    ...
    st.markdown("<hr style='border: 1px solid #4facfe; margin: 2rem 0;'>", unsafe_allow_html=True)
    ...
    if not categorized_data:
        ...
        st.markdown("<hr style='border: 1px solid #764ba2; margin: 1.5rem 0;'>", unsafe_allow_html=True)
        ...
        st.markdown("<hr style='border: 1px solid #56ab2f; margin: 2rem 0;'>", unsafe_allow_html=True)
        st.markdown("""
        ...
        # --- Agent Chat Logs ---
        st.markdown("<hr style='border: 1px solid #f093fb; margin: 2rem 0;'>", unsafe_allow_html=True)
        st.markdown("""
...
# --- FOOTER ---
st.markdown("""
    <hr style='border: 1px solid #667eea; margin-top: 3rem;'>
    <div style='text-align:center; color:#aaa; font-size:0.95rem; margin-top:1.5rem;'>
        © 2025 Bill Management Agent | Designed by YourName | Powered by Streamlit & Gemini AI
    </div>
""", unsafe_allow_html=True)